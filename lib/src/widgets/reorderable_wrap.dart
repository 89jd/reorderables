...
//        ),
  ...
  final Widget? footer;
  final BaseReorderableMixin? reorderableMixin;
    ...
    _listOverlayEntry = PassthroughOverlayEntry(
      ...
      builder: (BuildContext context) {
        return _ReorderableWrapContent(
          ...
          reorderableMixin: widget.reorderableMixin,
        );
      },
    );
  }
...
//      );
    ...
    double _getDraggingOpacity() {
      return widget.reorderableMixin == null ? _getDraggingOpacity() :
        widget.reorderableMixin!.getDraggingOpacity();
    }

    Widget _makeAppearingWidget(Widget child) {
      if (widget.reorderableMixin == null) {
        ...
        return widget.reorderableMixin!.makeAppearingWidget(
          child,
          _entranceController,
          null,
          widget.direction,
          index: _ghostDisplayIndex,
        );
      }
    }
    ...
    Widget _makeDisappearingWidget(Widget child) {
      if (widget.reorderableMixin == null) {
        ...
        return widget.reorderableMixin!.makeDisappearingWidget(
          child,
          _ghostController,
          null,
          widget.direction,
...
//      );
      ...
      Widget spacing = _draggingWidget == null
          ...
          : Opacity(opacity: _getDraggingOpacity(), child: _draggingWidget);
